...
//        // WHEN THEN
//        mockMvc.perform(MockMvcRequestBuilders.put("/12345")
//                        .contentType(MediaType.APPLICATION_JSON_VALUE)
//                        .content(request))
//                .andExpect(MockMvcResultMatchers.status().isOk())
//                .andExpect(MockMvcResultMatchers.jsonPath("result.id").value("test01010101"))
...
//
//        // WHEN THEN
//        mockMvc.perform(MockMvcRequestBuilders.get("/test01010101")
//                        .contentType(MediaType.APPLICATION_JSON_VALUE)
//                        .content(request))
//                .andExpect(MockMvcResultMatchers.status().isOk());
//    }
...
//
//        // WHEN THEN
//        mockMvc.perform(MockMvcRequestBuilders.get("/myInfo")
//                        .contentType(MediaType.APPLICATION_JSON_VALUE)
//                        .content(request))
//                .andExpect(MockMvcResultMatchers.status().isOk())
//                .andExpect(MockMvcResultMatchers.jsonPath("result.id").value("test01010101"));
